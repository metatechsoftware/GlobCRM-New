...
@Component({
  ...
  template: `
    <mat-card class="events-widget">
      <mat-card-header>
        <mat-icon class="events-widget__header-icon">calendar_month</mat-icon>
            ...
            <div class="events-widget__group">
              ...
              @for (event of group.events; track event.id) {
                <button class="events-widget__row" (click)="eventClicked.emit(event.id)">
                  <mat-icon class="events-widget__type-icon">
                    {{ event.type === 'Meeting' ? 'videocam' : 'phone' }}
                  </mat-icon>
