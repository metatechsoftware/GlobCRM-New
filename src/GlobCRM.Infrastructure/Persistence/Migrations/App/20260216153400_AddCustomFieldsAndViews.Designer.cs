...
namespace GlobCRM.Infrastructure.Persistence.Migrations.App
{
    ...
    [Migration("20260216153400_AddCustomFieldsAndViews")]
    partial class AddCustomFieldsAndViews
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<UserPreferencesData>("Preferences")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<WorkSchedule>("WorkSchedule")
                        .HasColumnType("jsonb")
