...
namespace GlobCRM.Infrastructure.Persistence.Migrations.App
{
    ...
    [Migration("20260222085723_AddKanbanCardAssignees")]
    partial class AddKanbanCardAssignees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.Integration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CredentialMask")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.IntegrationActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IntegrationId", "CreatedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("idx_integration_activity_logs_integration_created");

                    b.ToTable("integration_activity_logs", (string)null);
                });
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanBoard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardAssignee", b =>
                {
                    ...
                    b.ToTable("kanban_card_assignees", (string)null);
                });

            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("kanban_card_comments", (string)null);
                });

            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardLabel", b =>
                {
                    b.Property<Guid>("CardId")
                        .HasColumnType("uuid")
                        .HasColumnName("card_id");
                    ...
                    b.ToTable("kanban_card_labels", (string)null);
                });

            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("kanban_checklist_items", (string)null);
                });

            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("kanban_labels", (string)null);
                });
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.QuoteTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.IntegrationActivityLog", b =>
                {
                    b.HasOne("GlobCRM.Domain.Entities.Integration", "Integration")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanBoard", b =>
                {
                    b.HasOne("GlobCRM.Domain.Entities.ApplicationUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCard", b =>
                {
                    b.HasOne("GlobCRM.Domain.Entities.KanbanColumn", "Column")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardAssignee", b =>
                {
                    b.HasOne("GlobCRM.Domain.Entities.KanbanCard", "Card")
                        .WithMany("Assignees")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardComment", b =>
                {
                    ...
                    b.HasOne("GlobCRM.Domain.Entities.KanbanCardComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanCardLabel", b =>
                {
                    ...
                    b.HasOne("GlobCRM.Domain.Entities.KanbanLabel", "Label")
                        .WithMany("CardLabels")
            ...
            modelBuilder.Entity("GlobCRM.Domain.Entities.KanbanColumn", b =>
                {
                    b.HasOne("GlobCRM.Domain.Entities.KanbanBoard", "Board")
                        .WithMany("Columns")
