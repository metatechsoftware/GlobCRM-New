...
<task type="auto">
  ...
  <done>Organization.DefaultLanguage persisted to database with migration, admin can view/update via PUT endpoint, settings hub has Language card, and a minimal language settings page allows changing the org default between English and Turkish</done>
</task>
