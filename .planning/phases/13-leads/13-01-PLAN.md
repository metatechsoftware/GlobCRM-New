...
NOTE: This plan modifies 18 files across 3 tasks. Tasks 1, 2, and 3 MUST be executed sequentially (not in parallel) because Task 2 compiles Infrastructure against Task 1's Domain output, and Task 3 runs a migration against Task 2's EF configurations.
</objective>
...
<task type="auto">
  ...
  <action>
    ...
    - Create 5 LeadStages with IsSeedData=true:
      ...
      5. Converted (SortOrder=4, Color="#9c27b0", IsConverted=true, IsLost=false)
