...
must_haves:
  ...
  artifacts:
    ...
    - path: "globcrm-web/src/assets/i18n/products/en.json"
      ...
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/products/tr.json"
      provides: "Products feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/quotes/en.json"
      provides: "Quotes feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/quotes/tr.json"
      provides: "Quotes feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/requests/en.json"
      provides: "Requests feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/requests/tr.json"
      provides: "Requests feature Turkish translations"
      contains: "list"
  key_links:
    ...
    - from: "globcrm-web/src/app/features/activities/activity-list/activity-list.component.ts"
      to: "globcrm-web/src/assets/i18n/activities/en.json"
      via: "transloco pipe referencing scoped activity keys"
      pattern: "'list\\.|'detail\\.|'form\\."
    - from: "globcrm-web/src/app/features/products/product-list/product-list.component.ts"
      to: "globcrm-web/src/assets/i18n/products/en.json"
      via: "transloco pipe referencing scoped product keys"
      pattern: "'list\\.|'detail\\.|'form\\."
---
