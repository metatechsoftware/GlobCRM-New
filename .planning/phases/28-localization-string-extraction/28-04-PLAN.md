...
files_modified:
  ...
  - globcrm-web/src/app/features/feed/emoji-picker/emoji-picker.component.ts
  - globcrm-web/src/app/features/feed/mention-typeahead/mention-typeahead.component.ts
autonomous: true
requirements:
  - LOCL-03
  - LOCL-10
...
must_haves:
  ...
  artifacts:
    - path: "globcrm-web/src/assets/i18n/emails/en.json"
      ...
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/emails/tr.json"
      provides: "Emails feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/email-templates/en.json"
      provides: "Email templates feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/email-templates/tr.json"
      provides: "Email templates feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/sequences/en.json"
      provides: "Sequences feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/sequences/tr.json"
      provides: "Sequences feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/notes/en.json"
      provides: "Notes feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/notes/tr.json"
      provides: "Notes feature Turkish translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/feed/en.json"
      provides: "Feed feature English translations"
      contains: "list"
    - path: "globcrm-web/src/assets/i18n/feed/tr.json"
      provides: "Feed feature Turkish translations"
      contains: "list"
  key_links:
    ...
    - from: "globcrm-web/src/app/features/email-templates/email-template-list/email-template-list.component.ts"
      to: "globcrm-web/src/assets/i18n/email-templates/en.json"
      via: "transloco pipe referencing scoped email-template keys"
      pattern: "'list\\.|'editor\\.|'messages\\."
    - from: "globcrm-web/src/app/features/sequences/sequence-builder/sequence-builder.component.ts"
      to: "globcrm-web/src/assets/i18n/sequences/en.json"
      via: "transloco pipe referencing scoped sequence builder keys"
      pattern: "'builder\\.|'enrollment\\.|'messages\\."
    - from: "globcrm-web/src/app/features/feed/feed-list/feed-list.component.ts"
      to: "globcrm-web/src/assets/i18n/feed/en.json"
      via: "transloco pipe referencing scoped feed keys"
      pattern: "'list\\.|'post\\.|'messages\\."
---
