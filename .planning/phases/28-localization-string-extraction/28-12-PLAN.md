...
<task type="auto">
  ...
  <done>
    All 9 entity list components (contacts, deals, companies, leads, activities, products, quotes, requests, emails) use labelKey in coreColumnDefs. Each scope's EN and TR JSON files have a `columns` section with matching keys.
  </done>
</task>
