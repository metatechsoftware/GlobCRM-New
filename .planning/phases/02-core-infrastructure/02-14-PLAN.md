...
<task type="auto">
  ...
  <action>
    ...
    **IMPORTANT:** Do NOT run `dotnet ef database update` in this task — migration application happens during E2E verification or deployment. Just create and verify the migration compiles.
