...
<task type="auto">
  ...
  <action>
    ...
    **Part D: AppComponent layout refactor**
    ...
    1. Add imports: `MatSidenavModule` from `@angular/material/sidenav`. **Do NOT import `EntityPreviewSidebarComponent` here** -- it does not exist yet. It will be created in Task 2, which adds the import.
    ...
    <mat-sidenav-container class="app-sidenav-container"
      ...
      @if (showNavbar()) {
        <mat-sidenav #previewDrawer
          ...
          <!-- EntityPreviewSidebarComponent selector will be added by Task 2 after the component is created -->
        </mat-sidenav>
      }
...
<task type="auto">
  ...
  <action>
    **Part A-0: Wire EntityPreviewSidebarComponent into AppComponent**

    Now that the component is being created in this task, update `app.component.ts`:
    1. Add `EntityPreviewSidebarComponent` to the component's `imports` array.
    2. Replace the placeholder comment inside the `<mat-sidenav>` (added in Task 1) with `<app-entity-preview-sidebar />`.
