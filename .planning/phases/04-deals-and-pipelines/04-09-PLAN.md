...
<task type="auto">
  ...
  <action>
    ...
    **related-entity-tabs.component.ts — Enable Deals tabs:**
    ...
    Note: The Company and Contact detail components will need to provide content for these newly enabled tabs. For now, enable the tab and add a simple placeholder that shows deal count and links to filtered deal list (e.g., "View X deals" linking to /deals?companyId=xxx). Full tab content with inline deal list can be enhanced in future phases.
  </action>
  <verify>
